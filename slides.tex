...
\begin{frame}{intuitionistic truth vs constructive truth}
  \only<2>{
    a statement is intuitionistically true if it is forced at all nodes
  }

  \only<3->{
    \sout{a statement is intuitionistically true if it is forced at all nodes}
  }

  \only<4->{
    \alert{a statement is constructively true if it is forced at all nodes}
  }
